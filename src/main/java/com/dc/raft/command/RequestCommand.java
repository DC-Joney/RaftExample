...
public abstract class RequestCommand extends RemoteCommand {
    ...
    public void setRequestAddress(InetSocketAddress socketAddress) {
        this.putHeader(REQUEST_ADDRESS, socketAddress.toString());
    }
